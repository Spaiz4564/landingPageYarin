...
export default {
 ...
 data() {
  ...
  { title: 'ריפוד תותבות', text: 'עם השנים אנו מאבדים את העצם שעליה נמצאת התותבת. במצב כזה, יש צורך לחדש את החלק הפנימי של התותבת על מנת לשפר את האחיזה, מחליפים את החלק הפנימי של התותבת לחדש.', primaryColor: '#fbf9f2', secondaryColor: '#cec720' },
